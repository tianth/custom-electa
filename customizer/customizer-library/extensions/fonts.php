...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'electa' ),
		'cyrillic'     => __( 'Cyrillic', 'electa' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'electa' ),
		'devanagari'   => __( 'Devanagari', 'electa' ),
		'greek'        => __( 'Greek', 'electa' ),
		'greek-ext'    => __( 'Greek Extended', 'electa' ),
		'khmer'        => __( 'Khmer', 'electa' ),
		'latin'        => __( 'Latin', 'electa' ),
		'latin-ext'    => __( 'Latin Extended', 'electa' ),
		'vietnamese'   => __( 'Vietnamese', 'electa' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'electa' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'electa' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'electa' ),
